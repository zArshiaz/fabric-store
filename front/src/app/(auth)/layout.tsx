        ...
        <div className={'w-screen h-screen flex items-center justify-center overscroll-y-auto  '}>
            <div className={' bg-white rounded-2xl shadow-2xl overflow-hidden w-[380px]'}>
                ...
                <div className="flex bg-gray-50">
                    <Link href={'/login'} className={`flex-1 py-4 px-6 text-center text-gray-500  hover:text-gray-700 transition-all duration-300
                            ${pathname==='/login'&& 'text-red-700 border-b-2 border-red-700 bg-white'}`}
                    >
                    ورود
                    </Link>
                    <Link href={'/register'} className={`flex-1 py-4 px-6 text-center text-gray-500hover:text-gray-700 transition-all duration-300
